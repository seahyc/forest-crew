...
1. On a phone, hold one hand in front of the camera. A persistent skeleton-only guide shows exactly what is detected. Desktop two-hand mode remains available.
...
3. Point one index finger with the other fingers curled to use the hose. Hold briefly (150 ms) to start. Your other hand can be absent or relaxed; the gesture is the same in either walking mode. Sweep the reticle across the fires. Relax the stance to return to walking. The hose reaches 14 metres; an amber aim ring means move closer or aim lower.
