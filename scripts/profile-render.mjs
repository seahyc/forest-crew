...
try{
 ...
 await page.goto('http://127.0.0.1:4180/?qa=1');await page.waitForFunction(()=>window.__forestQA?.input().workerReady,null,{timeout:60000});await page.waitForTimeout(3000);
